# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2018-02-05 21:48
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('calculator', '0002_auto_20180205_1529'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('extra_seating', models.CharField(choices=[('x1_and_x4', 'X1 and X4'), ('hiring', 'Hiring and Other Commercial Vehicles')], max_length=50)),
                ('cubic_capacity', models.CharField(choices=[('Above_2000', 'Above 2000'), ('up_to_1600', 'Up to 1600'), ('1600_to_2000', '1600 to 2000')], max_length=50)),
                ('usage', models.CharField(choices=[('private', 'Private'), ('commercial', 'Commercial')], max_length=50)),
                ('age', models.CharField(choices=[('five', '5 to 10 years'), ('above', 'Above 10 years'), ('one', '1 to 5 years')], max_length=50)),
            ],
        ),
        migrations.AddField(
            model_name='insurancepayout',
            name='vehicle',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='calculator.Vehicle'),
        ),
    ]
